...
//     }
        ...
        function expandEvent(e) {
            ...
            let more =  document.getElementById(`more-${e.target.id}`);
...
<div class="mt-10 md:text-center m-auto md:w-5/12 rounded-md border-2">
    ...
    <div class="md:px-8 md:py-4 py-2">
        ...
        <div class="mt-4 m-auto w-10/12">
            <div class="rounded-md border-2 bg-yellow-50">
                <div class="text-left p-4 pb-0">
                    <p class="text-lg font-bold">Discuss Local Housing Plans</p>
                ...
                <div class="flex bg-yellow-50 p-4 pt-0 text-left">
                    <p class="mt-2 text-md text-blue-700 font-semibold">Sat, Oct 25th at 8:00AM <br>at Cherry Hill Park</p>
                ...
                <div id="more-12" class="hidden text-left p-4 pb-4">
                    <div class="mb-4 ml-auto text-right" style=''>
                        <ul class='inline-flex'>
                          <li class='py-2 px-6 bg-white rounded-t-lg text-gray-500 bg-gray-200 cursor-pointer'>Discussion</li>
                          <li class='py-2 px-6 bg-white rounded-t-lg cursor-default'>Location</li>
                        </ul>
                    </div>
        ...
        <button type="button" style="" class="mt-4 mb-2 rounded-full shadow bg-white px-2 py-1 text-right block ml-auto">+ New Event</button>
